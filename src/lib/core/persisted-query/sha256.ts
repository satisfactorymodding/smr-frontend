// TAKEN AND MODIFIED FROM https://github.com/FormidableLabs/urql/blob/main/exchanges/persisted-fetch/src/sha256.ts
...
const nodeCrypto =
  typeof window === 'undefined' ? (typeof require === 'undefined' ? null : eval("require('crypto')")) : null;
