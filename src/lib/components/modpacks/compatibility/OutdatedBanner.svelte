...
{#if !works}
  <div
    class="modpack-outdated-stripe"
    style="max-width: inherit;"
    class:modpack-damaged={worst === CompatibilityState.Damaged}
    class:modpack-broken={worst === CompatibilityState.Broken}
    class:modpack-logo-outdated={logo} />
{/if}
