<script lang="ts">
  ...
  import CompatibilityStateText from '$lib/components/modpacks/compatibility/CompatibilityStateText.svelte';
  ...
  export const compatibilityStateDescriptions: {
    ...
    Works: $t('compatibility-info.modpack.state.works.description'),
    Damaged: $t('compatibility-info.modpack.state.damaged.description'),
    Broken: $t('compatibility-info.modpack.state.broken.description'),
    Unknown: $t('compatibility-info.modpack.state.unknown.description')
  };
</script>

<div>
  {$t('compatibility-info.modpack.maintained-by')}
