<div>
  ...
  <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with
    regards to the information that they shared and/or collect in ficsit.app. This policy is not applicable to any
  ...
  <p>ficsit.app follows a standard procedure of using log files. These files log visitors when they visit
    ...
    and the <a href="https://www.privacypolicytemplate.net/">Privacy Policy Template</a>.</p>

  <h2>Cookies and Web Beacons</h2>

  <p>Like any other website, ficsit.app uses 'cookies'. These cookies are used to store information including
  ...
  <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are
    used in their respective advertisements and links that appear on ficsit.app, which are sent directly to users'
  ...
  <p>Note that ficsit.app has no access to or control over these cookies that are used by third-party
    advertisers.</p>

  <h2>Third Party Privacy Policies</h2>

  <p>ficsit.app's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to
  ...
  <p>ficsit.app does not knowingly collect any Personal Identifiable Information from children under the age of
