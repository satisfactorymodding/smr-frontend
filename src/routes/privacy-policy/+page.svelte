...
<div class="card p-4">
  <section class="p-4">
    ...
    <p>
      ...
      Privacy Policy document contains types of information that is collected and recorded by ficsit.app and how we use
      it.
    </p>
    ...
    <p>
      ...
      the information that they shared and/or collect in ficsit.app. This policy is not applicable to any information
    ...
    <p>
      ficsit.app follows a standard procedure of using log files. These files log visitors when they visit websites. All
      ...
      help of the <a href="https://www.privacypolicygenerator.info">Privacy Policy Generator</a>
      and the <a href="https://www.privacypolicytemplate.net/">Privacy Policy Template</a>.
    </p>

    <h2>Cookies and Web Beacons</h2>

    <p>
      Like any other website, ficsit.app uses 'cookies'. These cookies are used to store information including visitors'
    ...
    <p>
      For more general information on cookies, please read <a href="https://www.cookieconsent.com/what-are-cookies/"
        >"What Are Cookies"</a
      >.
    </p>
    ...
    <p>You may consult this list to find the Privacy Policy for each of the advertising partners of ficsit.app.</p>

    <p>
      Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used in
      their respective advertisements and links that appear on ficsit.app, which are sent directly to users' browser.
    ...
    <p>Note that ficsit.app has no access to or control over these cookies that are used by third-party advertisers.</p>

    <h2>Third Party Privacy Policies</h2>

    <p>
      ficsit.app's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to consult
    ...
    <p>
      ficsit.app does not knowingly collect any Personal Identifiable Information from children under the age of 13. If
